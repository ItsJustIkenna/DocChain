                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          {appointment.status === 'completed' && (
                            <button
                              ...
                              className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-2 px-6 rounded-lg font-semibold hover:from-yellow-600 hover:to-orange-600 transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center"
                            >
